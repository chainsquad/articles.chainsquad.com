...
Other ecosystems are smarter than that, they leverage the technology to allow application-specific blockchains, in short _app-chains_. If they break, the app is broken, all other apps, however, run their own blockchain and are independent. The [Cosmos Network](https://cosmos.network) with the [Cosmos SDK](https://v1.cosmos.network/sdk) are a prime example of how to deal with it. Congratulations.
